        ...
        <div className="flex flex-col items-center gap-8 lg:flex-row lg:gap-14">
          <div className="max-w-[560px] space-y-4">
            ...
            <div className="item-start flex w-full flex-col justify-between gap-4">
              <h1 className="max-w-[640px] text-[28px] font-medium md:text-h2">Timeline Information for Easier Done</h1>
              <div className="space-y-8">
                <p className="text-lg text-neutral-500 lg:max-w-[490px]">
                  See how work maps out over time. Manage dependent, overlapping, and unscheduled tasks and create
                  plans.
                </p>
                <Button
                  as={Link}
