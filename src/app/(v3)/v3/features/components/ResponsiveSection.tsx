        ...
        <div className="flex flex-col items-center gap-8 lg:flex-row lg:gap-14">
          ...
          <div className="max-w-[720px] space-y-4">
            ...
            <div className="item-start flex w-full flex-col justify-between gap-4">
              <h1 className="max-w-[640px] text-[28px] font-medium md:text-h1">Mobile-Friendly Design</h1>
              <div className="space-y-8">
                <p className="text-lg text-neutral-500 lg:max-w-[490px]">
                  Work Anywhere, Anytime! Taskify&apos;s is designed to be mobile-friendly, so you can manage your tasks
                  on the go. Whether you&apos;re on your smartphone or tablet, access Taskify seamlessly from any device
                  and stay productive wherever you are.
                </p>
                <Button
                  as={Link}
                  href="#"
