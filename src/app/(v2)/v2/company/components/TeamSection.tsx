...
const TeamSection = () => {
  ...
  return (
    <motion.section
      ...
      className="relative overflow-hidden bg-neutral-50 px-5 py-14 md:py-[124.5px] xl:p-20"
    >
      <div className="container mx-auto">
        <div className="space-y-14">
          <div className="max-w-[584px] space-y-4">
            ...
            <motion.p variants={fadeUpChildVariants} className="max-w-[481px] text-sm text-neutral-500 md:text-base">
